...
#ifndef GOOGLE_PROTOBUF_INCLUDED_dox_2fproto_2funit_5ftest_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_dox_2fproto_2funit_5ftest_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_dox_2fproto_2funit_5ftest_2eproto
...
struct TableStruct_dox_2fproto_2funit_5ftest_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_dox_2fproto_2funit_5ftest_2eproto;
namespace senior {
namespace dox {
namespace proto {
class Chatter;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::senior::dox::proto::Chatter* Arena::CreateMaybeMessage<::senior::dox::proto::Chatter>(Arena*);
template<> ::senior::dox::proto::ChatterBenchmark* Arena::CreateMaybeMessage<::senior::dox::proto::ChatterBenchmark>(Arena*);
template<> ::senior::dox::proto::UnitTest* Arena::CreateMaybeMessage<::senior::dox::proto::UnitTest>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace senior {
namespace dox {
namespace proto {
...
class UnitTest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:senior.dox.proto.UnitTest) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "senior.dox.proto.UnitTest";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:senior.dox.proto.UnitTest)
 private:
  class _Internal;
  ...
  friend struct ::TableStruct_dox_2fproto_2funit_5ftest_2eproto;
};
// -------------------------------------------------------------------

class Chatter final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:senior.dox.proto.Chatter) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "senior.dox.proto.Chatter";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:senior.dox.proto.Chatter)
 private:
  class _Internal;
...
class ChatterBenchmark final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:senior.dox.proto.ChatterBenchmark) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "senior.dox.proto.ChatterBenchmark";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:senior.dox.proto.ChatterBenchmark)
 private:
  class _Internal;
...
inline const std::string& UnitTest::class_name() const {
  // @@protoc_insertion_point(field_get:senior.dox.proto.UnitTest.class_name)
...
void UnitTest::set_class_name(ArgT0&& arg0, ArgT... args) {
 ...
 class_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:senior.dox.proto.UnitTest.class_name)
}
inline std::string* UnitTest::mutable_class_name() {
  std::string* _s = _internal_mutable_class_name();
  // @@protoc_insertion_point(field_mutable:senior.dox.proto.UnitTest.class_name)
  return _s;
}
...
inline std::string* UnitTest::release_class_name() {
  // @@protoc_insertion_point(field_release:senior.dox.proto.UnitTest.class_name)
...
inline void UnitTest::set_allocated_class_name(std::string* class_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:senior.dox.proto.UnitTest.class_name)
}
...
inline const std::string& UnitTest::case_name() const {
  // @@protoc_insertion_point(field_get:senior.dox.proto.UnitTest.case_name)
...
void UnitTest::set_case_name(ArgT0&& arg0, ArgT... args) {
 ...
 case_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:senior.dox.proto.UnitTest.case_name)
}
inline std::string* UnitTest::mutable_case_name() {
  std::string* _s = _internal_mutable_case_name();
  // @@protoc_insertion_point(field_mutable:senior.dox.proto.UnitTest.case_name)
  return _s;
}
...
inline std::string* UnitTest::release_case_name() {
  // @@protoc_insertion_point(field_release:senior.dox.proto.UnitTest.case_name)
...
inline void UnitTest::set_allocated_case_name(std::string* case_name) {
  ...
  case_name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), case_name,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:senior.dox.proto.UnitTest.case_name)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 Chatter::timestamp() const {
  // @@protoc_insertion_point(field_get:senior.dox.proto.Chatter.timestamp)
...
inline void Chatter::set_timestamp(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  ...
  // @@protoc_insertion_point(field_set:senior.dox.proto.Chatter.timestamp)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 Chatter::lidar_timestamp() const {
  // @@protoc_insertion_point(field_get:senior.dox.proto.Chatter.lidar_timestamp)
...
inline void Chatter::set_lidar_timestamp(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  ...
  // @@protoc_insertion_point(field_set:senior.dox.proto.Chatter.lidar_timestamp)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 Chatter::seq() const {
  // @@protoc_insertion_point(field_get:senior.dox.proto.Chatter.seq)
...
inline void Chatter::set_seq(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  ...
  // @@protoc_insertion_point(field_set:senior.dox.proto.Chatter.seq)
}
...
inline const std::string& Chatter::content() const {
  // @@protoc_insertion_point(field_get:senior.dox.proto.Chatter.content)
...
void Chatter::set_content(ArgT0&& arg0, ArgT... args) {
 ...
 content_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:senior.dox.proto.Chatter.content)
}
inline std::string* Chatter::mutable_content() {
  std::string* _s = _internal_mutable_content();
  // @@protoc_insertion_point(field_mutable:senior.dox.proto.Chatter.content)
  return _s;
}
...
inline std::string* Chatter::release_content() {
  // @@protoc_insertion_point(field_release:senior.dox.proto.Chatter.content)
...
inline void Chatter::set_allocated_content(std::string* content) {
  ...
  content_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), content,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:senior.dox.proto.Chatter.content)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 ChatterBenchmark::stamp() const {
  // @@protoc_insertion_point(field_get:senior.dox.proto.ChatterBenchmark.stamp)
...
inline void ChatterBenchmark::set_stamp(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  ...
  // @@protoc_insertion_point(field_set:senior.dox.proto.ChatterBenchmark.stamp)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 ChatterBenchmark::seq() const {
  // @@protoc_insertion_point(field_get:senior.dox.proto.ChatterBenchmark.seq)
  return _internal_seq();
}
...
inline void ChatterBenchmark::set_seq(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _internal_set_seq(value);
  // @@protoc_insertion_point(field_set:senior.dox.proto.ChatterBenchmark.seq)
}
...
inline const std::string& ChatterBenchmark::content() const {
  // @@protoc_insertion_point(field_get:senior.dox.proto.ChatterBenchmark.content)
  return _internal_content();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ChatterBenchmark::set_content(ArgT0&& arg0, ArgT... args) {
 ...
 content_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:senior.dox.proto.ChatterBenchmark.content)
}
inline std::string* ChatterBenchmark::mutable_content() {
  std::string* _s = _internal_mutable_content();
  // @@protoc_insertion_point(field_mutable:senior.dox.proto.ChatterBenchmark.content)
  return _s;
}
...
inline std::string* ChatterBenchmark::release_content() {
  // @@protoc_insertion_point(field_release:senior.dox.proto.ChatterBenchmark.content)
  if (!_internal_has_content()) {
    return nullptr;
  }
  _has_bits_[0] &= ~0x00000001u;
...
inline void ChatterBenchmark::set_allocated_content(std::string* content) {
  ...
  content_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), content,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:senior.dox.proto.ChatterBenchmark.content)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_dox_2fproto_2funit_5ftest_2eproto
