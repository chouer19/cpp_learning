...
#ifndef GOOGLE_PROTOBUF_INCLUDED_dox_2fproto_2fperf_5fconf_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_dox_2fproto_2fperf_5fconf_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_dox_2fproto_2fperf_5fconf_2eproto
...
struct TableStruct_dox_2fproto_2fperf_5fconf_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_dox_2fproto_2fperf_5fconf_2eproto;
namespace senior {
namespace dox {
namespace proto {
class PerfConf;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::senior::dox::proto::PerfConf* Arena::CreateMaybeMessage<::senior::dox::proto::PerfConf>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace senior {
namespace dox {
namespace proto {
...
class PerfConf final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:senior.dox.proto.PerfConf) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "senior.dox.proto.PerfConf";
  }
  protected:
  ...
  public:
  void clear_type();
  ::senior::dox::proto::PerfType type() const;
  void set_type(::senior::dox::proto::PerfType value);
  private:
  ::senior::dox::proto::PerfType _internal_type() const;
  void _internal_set_type(::senior::dox::proto::PerfType value);
  public:

  // @@protoc_insertion_point(class_scope:senior.dox.proto.PerfConf)
 private:
  class _Internal;
  ...
  bool enable_;
  int type_;
  friend struct ::TableStruct_dox_2fproto_2fperf_5fconf_2eproto;
};
// ===================================================================
...
inline bool PerfConf::enable() const {
  // @@protoc_insertion_point(field_get:senior.dox.proto.PerfConf.enable)
...
inline void PerfConf::set_enable(bool value) {
  ...
  // @@protoc_insertion_point(field_set:senior.dox.proto.PerfConf.enable)
}
...
inline ::senior::dox::proto::PerfType PerfConf::_internal_type() const {
  return static_cast< ::senior::dox::proto::PerfType >(type_);
}
inline ::senior::dox::proto::PerfType PerfConf::type() const {
  // @@protoc_insertion_point(field_get:senior.dox.proto.PerfConf.type)
  return _internal_type();
}
inline void PerfConf::_internal_set_type(::senior::dox::proto::PerfType value) {
  assert(::senior::dox::proto::PerfType_IsValid(value));
  _has_bits_[0] |= 0x00000002u;
  type_ = value;
}
inline void PerfConf::set_type(::senior::dox::proto::PerfType value) {
  _internal_set_type(value);
  // @@protoc_insertion_point(field_set:senior.dox.proto.PerfConf.type)
}
...
template <> struct is_proto_enum< ::senior::dox::proto::PerfType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::senior::dox::proto::PerfType>() {
  return ::senior::dox::proto::PerfType_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_dox_2fproto_2fperf_5fconf_2eproto
