...
#ifndef GOOGLE_PROTOBUF_INCLUDED_dox_2fproto_2fqos_5fprofile_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_dox_2fproto_2fqos_5fprofile_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_dox_2fproto_2fqos_5fprofile_2eproto
...
struct TableStruct_dox_2fproto_2fqos_5fprofile_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_dox_2fproto_2fqos_5fprofile_2eproto;
namespace senior {
namespace dox {
namespace proto {
class QosProfile;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::senior::dox::proto::QosProfile* Arena::CreateMaybeMessage<::senior::dox::proto::QosProfile>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace senior {
namespace dox {
namespace proto {
...
class QosProfile final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:senior.dox.proto.QosProfile) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "senior.dox.proto.QosProfile";
  }
  protected:
  ...
  public:
  void clear_history();
  ::senior::dox::proto::QosHistoryPolicy history() const;
  void set_history(::senior::dox::proto::QosHistoryPolicy value);
  private:
  ::senior::dox::proto::QosHistoryPolicy _internal_history() const;
  void _internal_set_history(::senior::dox::proto::QosHistoryPolicy value);
  public:
  ...
  ::senior::dox::proto::QosReliabilityPolicy reliability() const;
  void set_reliability(::senior::dox::proto::QosReliabilityPolicy value);
  private:
  ::senior::dox::proto::QosReliabilityPolicy _internal_reliability() const;
  void _internal_set_reliability(::senior::dox::proto::QosReliabilityPolicy value);
  public:
  ...
  ::senior::dox::proto::QosDurabilityPolicy durability() const;
  void set_durability(::senior::dox::proto::QosDurabilityPolicy value);
  private:
  ::senior::dox::proto::QosDurabilityPolicy _internal_durability() const;
  void _internal_set_durability(::senior::dox::proto::QosDurabilityPolicy value);
  public:

  // @@protoc_insertion_point(class_scope:senior.dox.proto.QosProfile)
 private:
  class _Internal;
  ...
  int reliability_;
  int durability_;
  friend struct ::TableStruct_dox_2fproto_2fqos_5fprofile_2eproto;
};
// ===================================================================
...
inline ::senior::dox::proto::QosHistoryPolicy QosProfile::_internal_history() const {
  return static_cast< ::senior::dox::proto::QosHistoryPolicy >(history_);
}
inline ::senior::dox::proto::QosHistoryPolicy QosProfile::history() const {
  // @@protoc_insertion_point(field_get:senior.dox.proto.QosProfile.history)
  return _internal_history();
}
inline void QosProfile::_internal_set_history(::senior::dox::proto::QosHistoryPolicy value) {
  assert(::senior::dox::proto::QosHistoryPolicy_IsValid(value));
  _has_bits_[0] |= 0x00000002u;
  history_ = value;
}
inline void QosProfile::set_history(::senior::dox::proto::QosHistoryPolicy value) {
  _internal_set_history(value);
  // @@protoc_insertion_point(field_set:senior.dox.proto.QosProfile.history)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 QosProfile::depth() const {
  // @@protoc_insertion_point(field_get:senior.dox.proto.QosProfile.depth)
...
inline void QosProfile::set_depth(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:senior.dox.proto.QosProfile.depth)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 QosProfile::mps() const {
  // @@protoc_insertion_point(field_get:senior.dox.proto.QosProfile.mps)
...
inline void QosProfile::set_mps(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:senior.dox.proto.QosProfile.mps)
}
...
inline ::senior::dox::proto::QosReliabilityPolicy QosProfile::_internal_reliability() const {
  return static_cast< ::senior::dox::proto::QosReliabilityPolicy >(reliability_);
}
inline ::senior::dox::proto::QosReliabilityPolicy QosProfile::reliability() const {
  // @@protoc_insertion_point(field_get:senior.dox.proto.QosProfile.reliability)
  return _internal_reliability();
}
inline void QosProfile::_internal_set_reliability(::senior::dox::proto::QosReliabilityPolicy value) {
  assert(::senior::dox::proto::QosReliabilityPolicy_IsValid(value));
  _has_bits_[0] |= 0x00000008u;
  reliability_ = value;
}
inline void QosProfile::set_reliability(::senior::dox::proto::QosReliabilityPolicy value) {
  _internal_set_reliability(value);
  // @@protoc_insertion_point(field_set:senior.dox.proto.QosProfile.reliability)
}
...
inline ::senior::dox::proto::QosDurabilityPolicy QosProfile::_internal_durability() const {
  return static_cast< ::senior::dox::proto::QosDurabilityPolicy >(durability_);
}
inline ::senior::dox::proto::QosDurabilityPolicy QosProfile::durability() const {
  // @@protoc_insertion_point(field_get:senior.dox.proto.QosProfile.durability)
  return _internal_durability();
}
inline void QosProfile::_internal_set_durability(::senior::dox::proto::QosDurabilityPolicy value) {
  assert(::senior::dox::proto::QosDurabilityPolicy_IsValid(value));
  _has_bits_[0] |= 0x00000010u;
  durability_ = value;
}
inline void QosProfile::set_durability(::senior::dox::proto::QosDurabilityPolicy value) {
  _internal_set_durability(value);
  // @@protoc_insertion_point(field_set:senior.dox.proto.QosProfile.durability)
}
...
template <> struct is_proto_enum< ::senior::dox::proto::QosHistoryPolicy> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::senior::dox::proto::QosHistoryPolicy>() {
  return ::senior::dox::proto::QosHistoryPolicy_descriptor();
}
template <> struct is_proto_enum< ::senior::dox::proto::QosReliabilityPolicy> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::senior::dox::proto::QosReliabilityPolicy>() {
  return ::senior::dox::proto::QosReliabilityPolicy_descriptor();
}
template <> struct is_proto_enum< ::senior::dox::proto::QosDurabilityPolicy> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::senior::dox::proto::QosDurabilityPolicy>() {
  return ::senior::dox::proto::QosDurabilityPolicy_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_dox_2fproto_2fqos_5fprofile_2eproto
