...
#ifndef GOOGLE_PROTOBUF_INCLUDED_dox_2fproto_2fclock_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_dox_2fproto_2fclock_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_dox_2fproto_2fclock_2eproto
...
struct TableStruct_dox_2fproto_2fclock_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_dox_2fproto_2fclock_2eproto;
namespace senior {
namespace dox {
namespace proto {
class Clock;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::senior::dox::proto::Clock* Arena::CreateMaybeMessage<::senior::dox::proto::Clock>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace senior {
namespace dox {
namespace proto {
...
class Clock final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:senior.dox.proto.Clock) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:senior.dox.proto.Clock)
 private:
  class _Internal;
  ...
  friend struct ::TableStruct_dox_2fproto_2fclock_2eproto;
};
// ===================================================================
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 Clock::clock() const {
  // @@protoc_insertion_point(field_get:senior.dox.proto.Clock.clock)
...
inline void Clock::set_clock(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  ...
  // @@protoc_insertion_point(field_set:senior.dox.proto.Clock.clock)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_dox_2fproto_2fclock_2eproto
