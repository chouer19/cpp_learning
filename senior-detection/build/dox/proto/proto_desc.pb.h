...
#ifndef GOOGLE_PROTOBUF_INCLUDED_dox_2fproto_2fproto_5fdesc_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_dox_2fproto_2fproto_5fdesc_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_dox_2fproto_2fproto_5fdesc_2eproto
...
struct TableStruct_dox_2fproto_2fproto_5fdesc_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_dox_2fproto_2fproto_5fdesc_2eproto;
namespace senior {
namespace dox {
namespace proto {
class ProtoDesc;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::senior::dox::proto::ProtoDesc* Arena::CreateMaybeMessage<::senior::dox::proto::ProtoDesc>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace senior {
namespace dox {
namespace proto {
...
class ProtoDesc final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:senior.dox.proto.ProtoDesc) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "senior.dox.proto.ProtoDesc";
  }
  protected:
  ...
  ::senior::dox::proto::ProtoDesc* mutable_dependencies(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::senior::dox::proto::ProtoDesc >*
      mutable_dependencies();
  private:
  const ::senior::dox::proto::ProtoDesc& _internal_dependencies(int index) const;
  ::senior::dox::proto::ProtoDesc* _internal_add_dependencies();
  public:
  const ::senior::dox::proto::ProtoDesc& dependencies(int index) const;
  ::senior::dox::proto::ProtoDesc* add_dependencies();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::senior::dox::proto::ProtoDesc >&
      dependencies() const;
  ...
  // @@protoc_insertion_point(class_scope:senior.dox.proto.ProtoDesc)
 private:
  class _Internal;
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::senior::dox::proto::ProtoDesc > dependencies_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr desc_;
  friend struct ::TableStruct_dox_2fproto_2fproto_5fdesc_2eproto;
};
// ===================================================================
...
inline const std::string& ProtoDesc::desc() const {
  // @@protoc_insertion_point(field_get:senior.dox.proto.ProtoDesc.desc)
...
void ProtoDesc::set_desc(ArgT0&& arg0, ArgT... args) {
 ...
 desc_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:senior.dox.proto.ProtoDesc.desc)
}
inline std::string* ProtoDesc::mutable_desc() {
  std::string* _s = _internal_mutable_desc();
  // @@protoc_insertion_point(field_mutable:senior.dox.proto.ProtoDesc.desc)
  return _s;
}
...
inline std::string* ProtoDesc::release_desc() {
  // @@protoc_insertion_point(field_release:senior.dox.proto.ProtoDesc.desc)
...
inline void ProtoDesc::set_allocated_desc(std::string* desc) {
  ...
  // @@protoc_insertion_point(field_set_allocated:senior.dox.proto.ProtoDesc.desc)
}
...
inline ::senior::dox::proto::ProtoDesc* ProtoDesc::mutable_dependencies(int index) {
  // @@protoc_insertion_point(field_mutable:senior.dox.proto.ProtoDesc.dependencies)
  return dependencies_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::senior::dox::proto::ProtoDesc >*
ProtoDesc::mutable_dependencies() {
  // @@protoc_insertion_point(field_mutable_list:senior.dox.proto.ProtoDesc.dependencies)
  return &dependencies_;
}
inline const ::senior::dox::proto::ProtoDesc& ProtoDesc::_internal_dependencies(int index) const {
  return dependencies_.Get(index);
}
inline const ::senior::dox::proto::ProtoDesc& ProtoDesc::dependencies(int index) const {
  // @@protoc_insertion_point(field_get:senior.dox.proto.ProtoDesc.dependencies)
  return _internal_dependencies(index);
}
inline ::senior::dox::proto::ProtoDesc* ProtoDesc::_internal_add_dependencies() {
  return dependencies_.Add();
}
inline ::senior::dox::proto::ProtoDesc* ProtoDesc::add_dependencies() {
  ::senior::dox::proto::ProtoDesc* _add = _internal_add_dependencies();
  // @@protoc_insertion_point(field_add:senior.dox.proto.ProtoDesc.dependencies)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::senior::dox::proto::ProtoDesc >&
ProtoDesc::dependencies() const {
  // @@protoc_insertion_point(field_list:senior.dox.proto.ProtoDesc.dependencies)
  return dependencies_;
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_dox_2fproto_2fproto_5fdesc_2eproto
