...
// source: dox/proto/choreography_conf.proto
...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_dox_2fproto_2fchoreography_5fconf_2eproto[2];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_dox_2fproto_2fchoreography_5fconf_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_dox_2fproto_2fchoreography_5fconf_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_dox_2fproto_2fchoreography_5fconf_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::senior::dox::proto::ChoreographyTask, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::senior::dox::proto::ChoreographyTask, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::senior::dox::proto::ChoreographyTask, name_),
  PROTOBUF_FIELD_OFFSET(::senior::dox::proto::ChoreographyTask, processor_),
  PROTOBUF_FIELD_OFFSET(::senior::dox::proto::ChoreographyTask, prio_),
  0,
  1,
  2,
  PROTOBUF_FIELD_OFFSET(::senior::dox::proto::ChoreographyConf, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::senior::dox::proto::ChoreographyConf, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::senior::dox::proto::ChoreographyConf, choreography_processor_num_),
  PROTOBUF_FIELD_OFFSET(::senior::dox::proto::ChoreographyConf, choreography_affinity_),
  PROTOBUF_FIELD_OFFSET(::senior::dox::proto::ChoreographyConf, choreography_processor_policy_),
  PROTOBUF_FIELD_OFFSET(::senior::dox::proto::ChoreographyConf, choreography_processor_prio_),
  PROTOBUF_FIELD_OFFSET(::senior::dox::proto::ChoreographyConf, choreography_cpuset_),
  PROTOBUF_FIELD_OFFSET(::senior::dox::proto::ChoreographyConf, pool_processor_num_),
  PROTOBUF_FIELD_OFFSET(::senior::dox::proto::ChoreographyConf, pool_affinity_),
  PROTOBUF_FIELD_OFFSET(::senior::dox::proto::ChoreographyConf, pool_processor_policy_),
  PROTOBUF_FIELD_OFFSET(::senior::dox::proto::ChoreographyConf, pool_processor_prio_),
  PROTOBUF_FIELD_OFFSET(::senior::dox::proto::ChoreographyConf, pool_cpuset_),
  PROTOBUF_FIELD_OFFSET(::senior::dox::proto::ChoreographyConf, tasks_),
  6,
  0,
  1,
  7,
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 8, sizeof(::senior::dox::proto::ChoreographyTask)},
  { 11, 27, sizeof(::senior::dox::proto::ChoreographyConf)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::senior::dox::proto::_ChoreographyTask_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::senior::dox::proto::_ChoreographyConf_default_instance_),
};

const char descriptor_table_protodef_dox_2fproto_2fchoreography_5fconf_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n!dox/proto/choreography_conf.proto\022\020sen"
  "ior.dox.proto\"D\n\020ChoreographyTask\022\014\n\004nam"
  "e\030\001 \001(\t\022\021\n\tprocessor\030\002 \001(\005\022\017\n\004prio\030\003 \001(\r"
  ":\0011\"\365\002\n\020ChoreographyConf\022\"\n\032choreography"
  "_processor_num\030\001 \001(\r\022\035\n\025choreography_aff"
  "inity\030\002 \001(\t\022%\n\035choreography_processor_po"
  "licy\030\003 \001(\t\022#\n\033choreography_processor_pri"
  "o\030\004 \001(\005\022\033\n\023choreography_cpuset\030\005 \001(\t\022\032\n\022"
  "pool_processor_num\030\006 \001(\r\022\025\n\rpool_affinit"
  "y\030\007 \001(\t\022\035\n\025pool_processor_policy\030\010 \001(\t\022\033"
  "\n\023pool_processor_prio\030\t \001(\005\022\023\n\013pool_cpus"
  "et\030\n \001(\t\0221\n\005tasks\030\013 \003(\0132\".senior.dox.pro"
  "to.ChoreographyTask"
  ;
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_dox_2fproto_2fchoreography_5fconf_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_dox_2fproto_2fchoreography_5fconf_2eproto = {
  false, false, 499, descriptor_table_protodef_dox_2fproto_2fchoreography_5fconf_2eproto, "dox/proto/choreography_conf.proto", 
  &descriptor_table_dox_2fproto_2fchoreography_5fconf_2eproto_once, nullptr, 0, 2,
  schemas, file_default_instances, TableStruct_dox_2fproto_2fchoreography_5fconf_2eproto::offsets,
  file_level_metadata_dox_2fproto_2fchoreography_5fconf_2eproto, file_level_enum_descriptors_dox_2fproto_2fchoreography_5fconf_2eproto, file_level_service_descriptors_dox_2fproto_2fchoreography_5fconf_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_dox_2fproto_2fchoreography_5fconf_2eproto_getter() {
  return &descriptor_table_dox_2fproto_2fchoreography_5fconf_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_dox_2fproto_2fchoreography_5fconf_2eproto(&descriptor_table_dox_2fproto_2fchoreography_5fconf_2eproto);
namespace senior {
namespace dox {
namespace proto {
...
ChoreographyTask::ChoreographyTask(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:senior.dox.proto.ChoreographyTask)
}
ChoreographyTask::ChoreographyTask(const ChoreographyTask& from)
  ...
  // @@protoc_insertion_point(copy_constructor:senior.dox.proto.ChoreographyTask)
}
...
ChoreographyTask::~ChoreographyTask() {
  // @@protoc_insertion_point(destructor:senior.dox.proto.ChoreographyTask)
...
// @@protoc_insertion_point(message_clear_start:senior.dox.proto.ChoreographyTask)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          #ifndef NDEBUG
          ::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "senior.dox.proto.ChoreographyTask.name");
          #endif  // !NDEBUG
          CHK_(ptr);
...
::PROTOBUF_NAMESPACE_ID::uint8* ChoreographyTask::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:senior.dox.proto.ChoreographyTask)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (cached_has_bits & 0x00000001u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::VerifyUTF8StringNamedField(
      ...
      "senior.dox.proto.ChoreographyTask.name");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:senior.dox.proto.ChoreographyTask)
  return target;
}

size_t ChoreographyTask::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:senior.dox.proto.ChoreographyTask)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:senior.dox.proto.ChoreographyTask)
...
// @@protoc_insertion_point(class_specific_copy_from_start:senior.dox.proto.ChoreographyTask)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata ChoreographyTask::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_dox_2fproto_2fchoreography_5fconf_2eproto_getter, &descriptor_table_dox_2fproto_2fchoreography_5fconf_2eproto_once,
      file_level_metadata_dox_2fproto_2fchoreography_5fconf_2eproto[0]);
}
...
ChoreographyConf::ChoreographyConf(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:senior.dox.proto.ChoreographyConf)
}
ChoreographyConf::ChoreographyConf(const ChoreographyConf& from)
  ...
  // @@protoc_insertion_point(copy_constructor:senior.dox.proto.ChoreographyConf)
}
...
ChoreographyConf::~ChoreographyConf() {
  // @@protoc_insertion_point(destructor:senior.dox.proto.ChoreographyConf)
  if (GetArenaForAllocation() != nullptr) return;
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
...
// @@protoc_insertion_point(message_clear_start:senior.dox.proto.ChoreographyConf)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          #ifndef NDEBUG
          ::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "senior.dox.proto.ChoreographyConf.choreography_affinity");
          #endif  // !NDEBUG
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          #ifndef NDEBUG
          ::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "senior.dox.proto.ChoreographyConf.choreography_processor_policy");
          #endif  // !NDEBUG
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 42)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          #ifndef NDEBUG
          ::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "senior.dox.proto.ChoreographyConf.choreography_cpuset");
          #endif  // !NDEBUG
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 58)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          #ifndef NDEBUG
          ::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "senior.dox.proto.ChoreographyConf.pool_affinity");
          #endif  // !NDEBUG
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 8:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 66)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          #ifndef NDEBUG
          ::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "senior.dox.proto.ChoreographyConf.pool_processor_policy");
          #endif  // !NDEBUG
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 10:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 82)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          #ifndef NDEBUG
          ::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "senior.dox.proto.ChoreographyConf.pool_cpuset");
          #endif  // !NDEBUG
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // repeated .senior.dox.proto.ChoreographyTask tasks = 11;
      case 11:
...
::PROTOBUF_NAMESPACE_ID::uint8* ChoreographyConf::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:senior.dox.proto.ChoreographyConf)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (cached_has_bits & 0x00000001u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::VerifyUTF8StringNamedField(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::SERIALIZE,
      "senior.dox.proto.ChoreographyConf.choreography_affinity");
    target = stream->WriteStringMaybeAliased(
  ...
  if (cached_has_bits & 0x00000002u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::VerifyUTF8StringNamedField(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::SERIALIZE,
      "senior.dox.proto.ChoreographyConf.choreography_processor_policy");
    target = stream->WriteStringMaybeAliased(
  ...
  if (cached_has_bits & 0x00000004u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::VerifyUTF8StringNamedField(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::SERIALIZE,
      "senior.dox.proto.ChoreographyConf.choreography_cpuset");
    target = stream->WriteStringMaybeAliased(
  ...
  if (cached_has_bits & 0x00000008u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::VerifyUTF8StringNamedField(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::SERIALIZE,
      "senior.dox.proto.ChoreographyConf.pool_affinity");
    target = stream->WriteStringMaybeAliased(
  ...
  if (cached_has_bits & 0x00000010u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::VerifyUTF8StringNamedField(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::SERIALIZE,
      "senior.dox.proto.ChoreographyConf.pool_processor_policy");
    target = stream->WriteStringMaybeAliased(
  ...
  if (cached_has_bits & 0x00000020u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::VerifyUTF8StringNamedField(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::SERIALIZE,
      "senior.dox.proto.ChoreographyConf.pool_cpuset");
    target = stream->WriteStringMaybeAliased(
  ...
  // @@protoc_insertion_point(serialize_to_array_end:senior.dox.proto.ChoreographyConf)
  return target;
}

size_t ChoreographyConf::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:senior.dox.proto.ChoreographyConf)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:senior.dox.proto.ChoreographyConf)
  GOOGLE_DCHECK_NE(&from, this);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:senior.dox.proto.ChoreographyConf)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void ChoreographyConf::InternalSwap(ChoreographyConf* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &choreography_affinity_, GetArenaForAllocation(),
      &other->choreography_affinity_, other->GetArenaForAllocation()
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &choreography_processor_policy_, GetArenaForAllocation(),
      &other->choreography_processor_policy_, other->GetArenaForAllocation()
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &choreography_cpuset_, GetArenaForAllocation(),
      &other->choreography_cpuset_, other->GetArenaForAllocation()
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &pool_affinity_, GetArenaForAllocation(),
      &other->pool_affinity_, other->GetArenaForAllocation()
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &pool_processor_policy_, GetArenaForAllocation(),
      &other->pool_processor_policy_, other->GetArenaForAllocation()
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &pool_cpuset_, GetArenaForAllocation(),
      &other->pool_cpuset_, other->GetArenaForAllocation()
  );
...
::PROTOBUF_NAMESPACE_ID::Metadata ChoreographyConf::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_dox_2fproto_2fchoreography_5fconf_2eproto_getter, &descriptor_table_dox_2fproto_2fchoreography_5fconf_2eproto_once,
      file_level_metadata_dox_2fproto_2fchoreography_5fconf_2eproto[1]);
}
...
template<> PROTOBUF_NOINLINE ::senior::dox::proto::ChoreographyTask* Arena::CreateMaybeMessage< ::senior::dox::proto::ChoreographyTask >(Arena* arena) {
  return Arena::CreateMessageInternal< ::senior::dox::proto::ChoreographyTask >(arena);
}
template<> PROTOBUF_NOINLINE ::senior::dox::proto::ChoreographyConf* Arena::CreateMaybeMessage< ::senior::dox::proto::ChoreographyConf >(Arena* arena) {
  return Arena::CreateMessageInternal< ::senior::dox::proto::ChoreographyConf >(arena);
}
