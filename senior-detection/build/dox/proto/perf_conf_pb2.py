...
_PERFCONF = _descriptor.Descriptor(
  name='PerfConf',
  full_name='senior.dox.proto.PerfConf',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='enable', full_name='senior.dox.proto.PerfConf.enable', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='type', full_name='senior.dox.proto.PerfConf.type', index=1,
...
PerfConf = _reflection.GeneratedProtocolMessageType('PerfConf', (_message.Message,), {
  ...
  '__module__' : 'dox.proto.perf_conf_pb2'
