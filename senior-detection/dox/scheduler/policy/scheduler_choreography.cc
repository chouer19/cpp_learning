...
#include "dox/scheduler/policy/choreography_context.h"
#include "dox/scheduler/policy/classic_context.h"
...
SchedulerChoreography::SchedulerChoreography()
  ...
  if (PathExists(cfg_file) && GetProtoFromFile(cfg_file, &cfg)) {
    ...
    const senior::dox::proto::ChoreographyConf& choreography_conf =
